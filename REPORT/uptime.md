...
**Host Connectivity:** Online (0 historical outages recorded)
...
* **Services:**
  - `delightd-delightd-1` (`delightd-delightd`) - **Up 53 minutes**
...
* **Services:**
  - `la-domestique-geometry-engine-1` (`la-domestique-geometry-engine`) - **Up 6 minutes (healthy)**
    * Uptime:<br>![Uptime](la-domestique-geometry-engine-1_uptime.svg)
    * Churn:<br>![Churn](la-domestique-geometry-engine-1_churn.svg)
  - `la-domestique-web-1` (`la-domestique-web`) - **Up 49 minutes**
...
* **Services:**
  - `odysseus-odysseus-1` (`odysseus-odysseus`) - **Up 3 hours**
    ...
    * Churn:<br>![Churn](odysseus-odysseus-1_churn.svg)
  - `odysseus-searxng-1` (`searxng/searxng:2026.5.31-7159b8aed`) - **Up 3 hours (healthy)**
    * Uptime:<br>![Uptime](odysseus-searxng-1_uptime.svg)
    * Churn:<br>![Churn](odysseus-searxng-1_churn.svg)
  - `odysseus-chromadb-1` (`chromadb/chroma:latest`) - **Up 3 hours**
    * Uptime:<br>![Uptime](odysseus-chromadb-1_uptime.svg)
    * Churn:<br>![Churn](odysseus-chromadb-1_churn.svg)
  - `odysseus-ntfy-1` (`binwiederhier/ntfy`) - **Up 3 hours**
    * Uptime:<br>![Uptime](odysseus-ntfy-1_uptime.svg)
    * Churn:<br>![Churn](odysseus-ntfy-1_churn.svg)

### 🐳 `transparent`
* **Git:** branch `fix/dashboard-metrics`, 26 total commits, 1 PRs landed in last 7 days
* **Services:**
